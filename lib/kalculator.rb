...
loop do
  ...
  objectType =  {"bob" => Kalculator::MappedObject.new({"name" => Kalculator::String.new, "email" => Kalculator::String.new, "mother" => Kalculator::MappedObject.new({ "name" => Kalculator::String.new})})}
